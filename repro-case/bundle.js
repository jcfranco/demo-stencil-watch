...
const MyComponent$1 = class extends HTMLElement {
  constructor() {
    ...
    this.__registerHost();
    attachShadow(this);
    this.histWatcherCalls = 0;
    this.hasHistWatcherCalls = 0;
  }
  componentWillLoad() {
  ...
  histogramWatcher(newValue, oldValue) {
    if (newValue !== oldValue) {
      this.histWatcherCalls++;
    }
  }
  hasHistogramWatcher(newValue, oldValue) {
    if (newValue !== oldValue) {
      this.hasHistWatcherCalls++;
    }
  }
  render() {
    return (h("div", null, h("div", null, this.el.getAttribute('id')), h("div", null, "Histogram Watcher Calls: ", this.histWatcherCalls), h("div", null, "Has Histogram Watcher Calls: ", this.hasHistWatcherCalls)));
  }
  get el() { return this; }
  static get watchers() { return {
    "histogram": ["histogramWatcher"],
    "hasHistogram": ["hasHistogramWatcher"]
  }; }
  static get style() { return myComponentCss; }
};

const MyComponent = /*@__PURE__*/proxyCustomElement(MyComponent$1, [1,"my-component",{"histogram":[16],"hasHistogram":[516,"has-histogram"]}]);
